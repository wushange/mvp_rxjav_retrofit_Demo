...
public class EaseChatMessageList extends RelativeLayout {
     ...
     */
    public void init(List<EMMessage> messageList, int chatType, final EaseCustomChatRowProvider customChatRowProvider) {
        this.chatType = chatType;
        this.toChatUsername = toChatUsername;
        messageAdapter = new EaseMessageAdapter(context, messageList, chatType, listView);
    ...
    public void addMessage(EMMessage emMessage) {
        messageAdapter.addData(emMessage,false);
