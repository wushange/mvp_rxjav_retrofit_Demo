...
public class CustomerAdapter extends BaseAdapter implements SectionIndexer,
    ...
    public CustomerAdapter(Context context, List<User> members) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        try {
            ...
            if (convertView == null) {
                convertView = inflater.inflate(R.layout.item_customer_view,
                        null);
                userHandler = new MemberHandler();
                userHandler.ll_customer_item = (LinearLayout) convertView.findViewById(R.id.ll_customer_item);
