 ...
 */
public class MyFollowActivity extends MvpBaseSwipeBackActivity<MyFollowContract.MyFollowView, FollowPresenter> implements MyFollowContract.MyFollowView {
    ...
    public int bindLayout() {
        return R.layout.activity_myfollow_main_view;
    }

    @Override
    public void initView(View view) {
        appTitle.init(AppTitle.AppTitleStyle.BACK_TITLE);
        appTitle.setTitle("我的关注");
        adapter = new FollowAdapter(getContext(), members);
